...
function Snake() {//this is the snake constructor
  ...
  if((this.x < 0) || (this.x > w-scl) || (this.y < 0) || (this.y > h-scl)){
      //this.tail= 0;
    this.total= 0;
    document.getElementById('score').innerHTML= "Touched wall, your dead";
    noLoop();
  }
   ...
   for(var i = 0; i < this.tail.length; i++){
     ...
     if(d < 1){
       this.tail = [];
       this.total = 0;
      document.getElementById('score').innerHTML="Touched yourslef, your dead";
      noLoop();
    }
  }
  }
  ...
  this.update = function() {
   ...
   // this.x = constrain(this.x, 0, width - scl);
    ...
    //document.getElementById('score').innerHTML= this.x +" " + this.y;
  }
 this.show = function() {
